...
export default function LoginPage() {
    ...
    const handleLogin = async (form: FormData) => {
        "use server"; //TRANSFORMOU EM UMA SERVER ACTIONS
        ...
        <div className="grid grid-cols-[1.5fr,1fr] h-screen">
            <aside>
                <Image
                    ...
                    alt="Escritório com vários curriculos espalhados por todas as mesas."
            ...
            >
                ...
                <p className="text-sm text-muted-foreground">
                    Caso não tenha conta, ele será criado automaticamente.
                </p>

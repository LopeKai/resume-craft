...
const labels: Record<ResumeSections, Record<ResumesLanguages, string>> = {
    certifications: {
...
export function LayoutDragList({ title, fields }: LayoutDragListProps) {
    ...
    return (
        <div className="w-full p-2 bg-muted rounded">
            <p className="font-title text-sm font-bold mb-2">
                {title}
            </p>
